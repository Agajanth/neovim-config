...
map("n", "<Leader>rtr", ":FloatermNew bundle exec ruby -Itest % -n <cword><cr>", noremap)
map("n", "<Leader>rsr", ":FloatermNew ruby %<cr>", noremap)
map("n", "<Leader>rs", ":FloatermNew python3 %<cr>", noremap)
map("n", "<Leader>/", ":Ack!<Space>", opts)
map("n", "<Leader>cr",":FloatermNew cargo check",noremap)
map("n", "<Leader>ru",":FloatermNew cargo run",noremap)
map("n", "<Leader>br",":FloatermNew cargo build",noremap)
map("n", "<Leader>rbr",":FloatermNew cargo build --realase",noremap)
